...
class CoveragePolicyTest(unittest.TestCase):
    ...
    def test_navigation_ab_runner_is_ordered_and_never_promotes_default(self):
        ...
        self.assertIn('${scene}_"[0-9]*', source)
        self.assertIn("navigation preflight failed for profile", source)
        self.assertIn("navigation A/B sample failed for profile", source)

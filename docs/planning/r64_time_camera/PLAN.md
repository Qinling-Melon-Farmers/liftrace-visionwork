...
2026-09-11续议：用户将核心目标收敛为搜索效率，并要求先审阅后实施。最新方案、28轮实录重复路线及航带对照计划见[搜索效率计划](../search_efficiency_20260911/PLAN.md)；下文保留9月9日几何分析假设和历史结果。

2026-09-09。执行范围：rqt图更新、已有数据的离线分析、本地清理；时间优化、辅助相机与轻量仓功能改造只做计划。本次没有启动SITL、改飞行参数、启用辅助相机或安全返航，也不重打飞行包。任务优先级只在[ROADMAP](../../../VISION_2026_ROADMAP.md)维护。

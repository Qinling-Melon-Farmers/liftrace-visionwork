...
for name,case in cases.items():
    ...
    for strategy in ('false','true'):
        cmd=['roslaunch','--dump-params','uav_high_view','fast_comparison.launch',f'strategy:={strategy}',f'target_model_path:={model}',f'field_seed:={case["seed"]}']
    ...
    result.append(dict(case=name,stage_zero_fast=True,stage_one_slow=True,shared_gate_and_mission=True))

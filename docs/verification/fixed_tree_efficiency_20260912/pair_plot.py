...
sys.path.insert(0,str(ROOT/'docs/verification/local_entry_sitl_20260912'))
COLORS=['#276b96','#c26a24']

def pair(seed):
    records=[json.loads((OUT/f'fixed_tree_seed{seed}_{mode}_metrics.json').read_text()) for mode in ['baseline','active']]

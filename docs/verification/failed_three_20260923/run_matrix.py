...
def main():
    ...
    batch=R/'logs/failed_three_20260923_batch';batch.mkdir(exist_ok=True);statefile=batch/'matrix.json'
    ...
    for seed in SEEDS:
        ...
        prefix=f'failedthree_seed{seed}';before=set((R/'logs').glob(prefix+'_*'))

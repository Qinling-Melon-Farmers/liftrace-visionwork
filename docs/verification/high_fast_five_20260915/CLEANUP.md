...
退休r2026-competition-integrated和r2026-coverage-efficiency-research两个worktree，保留其Git分支来源、历史文档、日志、交付和忽略的非构建资产。归档位于/home/xhj/liftrace-archives下，旧路径是兼容符号链接，不再是Git工作树。重建可再生build/devel即可恢复开发，旧路径主要供历史报告/日志读取。

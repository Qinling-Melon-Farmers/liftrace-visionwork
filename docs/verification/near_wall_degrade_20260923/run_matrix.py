"""Authorized 34/38/40 regression for bounded near-wall delivery and fallback."""
...
def main():
    ...
    batch=R/'logs/near_wall_degrade_20260923_batch';batch.mkdir(exist_ok=True);statefile=batch/'matrix.json'
    ...
    for seed in SEEDS:
        ...
        prefix=f'nearwalldegrade_seed{seed}';before=set((R/'logs').glob(prefix+'_*'))

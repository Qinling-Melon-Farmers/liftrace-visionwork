...
> 2026-09-19：用户要求的新实验已增加连续80cm开口和4m外围墙，见[订正](../../planning/corridor_presentation_20260919/REPORT.md)。下文保留原左右门实验及当时结论，不自动视作新模式通过。

2026-09-10更新：用户授权的五组全随机SITL已完成，2/5整场PASS；LL/RR实际过门，LR第二门前失败，RL未采样。[报告与图表](../full_random_five_20260910/REPORT.md)。下文“尚未实跑”描述的是2026-09-09导出器初次交付时的历史边界。

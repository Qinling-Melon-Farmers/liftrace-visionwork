...
后续已完成[全随机树对照](../local_entry_sitl_20260912/REPORT.md)和[固定树四轮对照](../fixed_tree_efficiency_20260912/REPORT.md)：固定树批次限量记录开启时观察器整节点约0.53–0.59核，高于0.25核待验收目标。本文件核心离线改进不能代替整节点或板端验收。以下保留当时离线结果。
